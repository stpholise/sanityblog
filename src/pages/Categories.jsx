    ...
    <div>
        <header className="category-header w-full bg-[#eee6f6] xl:h-[400px] h-fit flex  items-center justify-center">
            <div className="container mx-auto max-w-[704px] p-2 w-full flex flex-col items-left md:items-center justify-center gap-3 text-center">
                ...
                <p className="text-[#6D6E76]">{category.description}</p>
       ...
       <section className="container mx-auto justify-start flex flex-col md:flex-row my-24 gap-3 sm:gap-8 lg:gap-28">
            <div className={`w-full  ${posts.length < 1 ? 'w-0' : ''}`}>
                ...
                <div className={`  w-full md:w-80 flex flex-col lg:gap-10 ${posts.length < 1 ? 'w-full mx-auto md:w-full' : ''}`}>
                    <h2 className='capitalize font-bold text-4xl '>Categories</h2>
                    <div className={`  w-full md:w-80 flex flex-col lg:gap-6 ${posts.length < 1 ? 'w-full mx-auto md:w-full' : ''}`}>
                        {
                             categories.slice(0,).map((category, index) => (
                                 <Link key={index} to={`/categories/${category._id}`} >
                                 <div  className='flex   justify-start items-center border-2 border-gray-300 w-full text-left gap-4 lg:h-24 lg:w-[300px] lg:p-6
                    ...
                    <div className=" w-full flex flex-col lg:gap-6 "> 
                        <h2 className='capitalize font-bold text-4xl '>  All Tags </h2>
